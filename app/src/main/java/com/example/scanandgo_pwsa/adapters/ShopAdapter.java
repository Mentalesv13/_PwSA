...
public class ShopAdapter extends RecyclerView.Adapter<ShopAdapter.ExampleViewHolder> {
    ...
    private ArrayList<ShopListItem> mExampleList;
    ...
    public ShopAdapter(ArrayList<ShopListItem> exampleList, Context context) {
    ...
    public void onBindViewHolder(ExampleViewHolder holder, final int position) {
        ...
        ShopListItem currentItem = mExampleList.get(position);
