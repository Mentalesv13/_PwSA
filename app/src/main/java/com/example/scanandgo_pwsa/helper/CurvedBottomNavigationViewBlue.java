...
public class CurvedBottomNavigationViewBlue extends BottomNavigationView {
    private Path mPath;
    ...
    public CurvedBottomNavigationViewBlue(Context context) {
        super(context);

        init();
    }

    public CurvedBottomNavigationViewBlue(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CurvedBottomNavigationViewBlue(Context context, AttributeSet attrs, int defStyleAttr) {
